...
async function initializeDatabase() {
    ...
    try {
        ...
        const countResult = await client.query('SELECT COUNT(*) as c FROM businesses');
        ...
        if (count === 0) {
            ...
            for (const biz of seedBusinesses) {
                ...
                `, [
                    biz.businessName, biz.category, biz.email, biz.phone,
                    biz.description, biz.address, biz.city, biz.state, biz.zipcode,
                    biz.serviceArea, biz.website, biz.yearsInBusiness,
                    biz.certifications, biz.services, biz.hours,
